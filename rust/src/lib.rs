//! Windissect-generated Rust FFI bindings for Windows.UI.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "177CDFB6D167A7FC87FF756A911F588D";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 1565331723;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 15] = [87, 105, 110, 100, 111, 119, 115, 46, 85, 73, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 1565331723 { return 0; }
